...
$U/_2048: $U/2048.o $(UCCLIB)
	$(LD) $(LDFLAGS) -N -e main -Ttext 0 -o $U/_2048 $U/2048.o $(UCCL)/libc.o $U/usys.o
	$(OBJDUMP) -S $U/_2048 > $U/2048.asm
	
$U/_minesweeper: $U/minesweeper.o $(UCCLIB)
